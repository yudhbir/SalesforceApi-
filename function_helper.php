...
function generate_token(){
	...
	curl_setopt_array($curl, array(
	  CURLOPT_URL => "https://login.salesforce.com/services/oauth2/token?grant_type=password&client_id=<client_id>&client_secret=<secreet>&username=<username>&password=<password>",
